...
|__/|__/_/ /_/\____/___//____/                                  
      """)
      os.system("curl https://api.hackertarget.com/whois/?q=" + d3)
      print("")
      quit()
    elif choice == 0:
      os.system("clear")
      print("This tool is available for all python installed machins  ")
      os.system("git clone https://github.com/")
      os.system("cd ipRecon && sudo bash ./update.sh")
      os.system("")
